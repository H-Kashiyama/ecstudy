...
ActiveRecord::Schema.define(version: 2019_10_09_025358) do
  ...
  create_table "esentences", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "esentence"
    t.text "memo"
    t.bigint "classifying_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["classifying_id"], name: "index_esentences_on_classifying_id"
  end
